...
The dashboard provides complete inventory analytics such as:
...
Supermarket inventory tracking
...
User enters grocery item details from dashboard.

Frontend sends request to Flask API.

Backend processes data using C++ logic.

System updates inventory dashboard.
